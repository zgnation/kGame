    ...
    <div class="usrBox">
      <div class="usrmsg">
        <div class="leftFirer">
          ...
          <div class="intro">
            <div class="day">第 {{playDay}} /20天</div>
            <div
              class="rate"
              :class="userA_color"
            >{{userA.rate}}%</div>
        ...
        <div class="rightFirer">
          <div class="intro">
            <div class="day">第 {{userB.day}} /20天</div>
            <div
              class="rate"
              :class="userB_color"
            >{{userB.rate}}%</div>
  ...
  methods: {
    setTime() {
      ...
      this.timer = setInterval(() => {
        if (this.playDay < 20 && !this.overA) {
          this.userA.time--;
          if (this.userA.time <= 0) {
            this.nextDay();
          }
        } else if (this.playDay == 20 && !this.overA) {
          this.overA = 1;
        }
        if (bi < 20 && !this.overB) {
          this.userB.time[bi]--;
